...
import com.criticalmass.datamatrix.dto.response.Response;
 ...
 */
@ControllerAdvice
public class MatrixControllerAdvice {
  ...
  @ExceptionHandler(value = {NullPointerException.class, IllegalArgumentException.class,
      NumberFormatException.class, UnsupportedOperationException.class})
  ...
  private ResponseEntity<Response> error(HttpStatus status, Exception e) {
    ...
    errorResponse.getErrors().add(new Error(OffsetDateTime.now(), status.value(), e.getMessage()));
